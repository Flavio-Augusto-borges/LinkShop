...
from app.routes.admin_mercado_livre_oauth import router as admin_mercado_livre_oauth_router
...
from app.routes.mercado_livre_oauth import router as mercado_livre_oauth_router
...
api_router.include_router(admin_catalog_router, prefix="/admin", tags=["admin-catalog"])
api_router.include_router(admin_integrations_router, prefix="/admin", tags=["admin-integrations"])
api_router.include_router(admin_mercado_livre_oauth_router, prefix="/admin", tags=["admin-mercado-livre-oauth"])
...
api_router.include_router(mercado_livre_oauth_router, prefix="/integrations", tags=["mercado-livre-oauth"])
